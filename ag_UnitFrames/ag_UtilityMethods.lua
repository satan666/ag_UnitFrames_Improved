...
function aUF:UnitDebuff(unit,id,filter)
	...
	if filter == 1 then
		...
		if ( self.CanDispel[eClass] and self.CanDispel[eClass][t] == true or ( eClass == "PRIEST" and (aura == "Interface\\Icons\\Spell_Holy_AshesToAshes" or aura == "Interface\\Icons\\Spell_Shadow_UnsummonBuilding")) ) then
