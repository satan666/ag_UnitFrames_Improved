	...
	local agDewdropMenu = {
		...
		args = {
			...
			BarStyle = {
				...
				validate = {"Classic", "Default","Smooth", "BantoBar", "BantoBar4ths", "BantoBar5ths", "Bars", "Bumps", "Button", "Charcoal", "Cloud", "Dabs", "DarkBottom", "Diagonal", "Fourths", "Fifths", "Gloss", "Grid", "Hatched", "Perl", "Rain", "Skewed", "Smudge", "Water", "Wisps"},
				order = 6,
			},
            Spacing1 = {
				name = " ",
			...
			-- Modification By Skela
			ThreeDimensionalPortraits = {
				name = L["threeDimensionalPortraits"],
				type = 'toggle',
				desc = L["ThreeDimensionalPortraitsDesc"],
				get = function()
					return self.db.profile.ThreeDimensionalPortraits
				end,
				set = function(option)
					self.db.profile.ThreeDimensionalPortraits = option
					ReloadUI()
				end,
				order = 13,
			},
			DynamicTexts = {
				name = L["dynamicTexts"],
				type = 'toggle',
				desc = L["DynamicTextsDesc"],
				get = function()
					return self.db.profile.DynamicTexts
				end,
				set = function(option)
					self.db.profile.DynamicTexts = option
				end,
				order = 14,
			},
			MenuOnModifiedClick = {
				name = L["menuOnModifiedClick"],
				type = 'toggle',
				desc = L["MenuOnModifiedClickDesc"],
				get = function()
					return self.db.profile.MenuOnModifiedClick
				end,
				set = function(option)
					self.db.profile.MenuOnModifiedClick = option
				end,
				order = 15,
			},
			-- Modification By Skela
